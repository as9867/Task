...
$(document).on("click", "#add", function(e) {
    ...
    if (name == "" || description == "" || p_id == "" || price == "" ||img.name == "") {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $("#recordTable").DataTable({
                data: response,
                responsive: true,
                dom: "<'row'<'col-sm-12 col-md-4'l><'col-sm-12 col-md-4'B><'col-sm-12 col-md-4'i><'col-sm-12 col-md-4'f>>" +
                    "<'row'<'col-sm-12'tr>>" +
...
$(document).on("click", "#update", function(e) {
    ...
    if (name == "" || p_id == "" || price == "" ||description == "") {
        alert("All field are required");
    } else {
        var fd = new FormData();
