							...
							<div class="modal-body">
								...
								<form id="addRecordForm">
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" id="p_id" placeholder="Product id" aria-label="p_id" aria-describedby="basic-addon1">
									</div>
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" id="name" placeholder="Product Name" aria-label="Username" aria-describedby="basic-addon1">
									</div>
										...
										<div class="col-md-12">
											...
											<form id="editForm">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control" id="edit_name" placeholder="Name" aria-label="Username" aria-describedby="basic-addon1">
												</div>
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control" id="edit_p_id" placeholder="Product Id" aria-label="Username" aria-describedby="basic-addon1">
												</div>
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control" id="edit_price" placeholder="Price">
												</div>
